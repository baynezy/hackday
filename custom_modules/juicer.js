...
exports.getArticles = function (params, callback) {
	...
	if (params.sources != undefined) uri += "&sources[]=" + params.sources;
	if (params.facets != undefined) uri += "&facets[]=" + params.facets;
	...
	if (params["like-ids"] != undefined) uri += "&like-ids[]=" + params["like-ids"];
